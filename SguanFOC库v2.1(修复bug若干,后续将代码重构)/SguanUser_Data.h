 ...
 * @LastEditTime: 2026-01-26 22:26:59
 * @FilePath: \demo_SguanFOCCode\SguanFOC\SguanUser_Data.h
...
void Sguan_ParameterSet(void) {
    #ifdef SguanMotor0
    /* 1.控制模式 */
    Sguan0.Control_mode = Current_SINGLE_MODE;
    /* 2.电机结构体变量 */
    ...
    /* 6.电流环D轴PID */
    Sguan0.Id.Kp = 0.03226f;
    Sguan0.Id.Ki = 0.000155f;
    Sguan0.Id.Kd = 0.0f;
    ...
    /* 7.电流环Q轴PID */
    Sguan0.Iq.Kp = 0.03226f;
    Sguan0.Iq.Ki = 0.000155f;
    Sguan0.Iq.Kd = 0.0f;
    Sguan0.Iq.OutMax = 0.9f;
    Sguan0.Iq.OutMin = -0.9f;
    Sguan0.Iq.D_Filter = 0.2f;
    Sguan0.Iq.ErrLimltFlag = 0;
    Sguan0.Iq.ErrMax = 0.0f;
    Sguan0.Iq.ErrMin = 0.0f;
    /* 8.电流采样结构体变量 */
    Sguan0.Current.Dir_a = 0;
    Sguan0.Current.Dir_b = 0;
    Sguan0.Current.Dir_c = 0;
    Sguan0.Current.Id_Filter = 0.005f;
    Sguan0.Current.Iq_Filter = 0.005f;
    ...
    /* 7.电流环Q轴PID */
    Sguan1.Iq.Kp = 0.02226f;
    Sguan1.Iq.Ki = 0.000115f;
    Sguan1.Iq.Kd = 0.0f;
    Sguan1.Iq.OutMax = 0.9f;
    Sguan1.Iq.OutMin = -0.9f;
    Sguan1.Iq.D_Filter = 0.2f;
    Sguan1.Iq.ErrLimltFlag = 0;
    Sguan1.Iq.ErrMax = 0.0f;
    Sguan1.Iq.ErrMin = 0.0f;
    /* 8.电流采样结构体变量 */
    ...
    /* 7.电流环Q轴PID */
    Sguan2.Iq.Kp = 0.02226f;
    Sguan2.Iq.Ki = 0.000115f;
    Sguan2.Iq.Kd = 0.0f;
    Sguan2.Iq.OutMax = 0.9f;
    Sguan2.Iq.OutMin = -0.9f;
    Sguan2.Iq.D_Filter = 0.2f;
    Sguan2.Iq.ErrLimltFlag = 0;
    Sguan2.Iq.ErrMax = 0.0f;
    Sguan2.Iq.ErrMin = 0.0f;
    /* 8.电流采样结构体变量 */
    ...
    /* 7.电流环Q轴PID */
    Sguan3.Iq.Kp = 0.02226f;
    Sguan3.Iq.Ki = 0.000115f;
    Sguan3.Iq.Kd = 0.0f;
    Sguan3.Iq.OutMax = 0.9f;
    Sguan3.Iq.OutMin = -0.9f;
    Sguan3.Iq.D_Filter = 0.2f;
    Sguan3.Iq.ErrLimltFlag = 0;
    Sguan3.Iq.ErrMax = 0.0f;
    Sguan3.Iq.ErrMin = 0.0f;
    /* 8.电流采样结构体变量 */
...
uint32_t SguanUser_GetTick(void) {
    ...
    Tick_num = HAL_GetTick();
    return Tick_num;
}

int32_t SguanUser_ReadADC_Raw(uint8_t Motor_CH,uint8_t Current_CH) {
    int32_t ADC_num;
    switch (Motor_CH)
    {
    case 0:
