...
static inline void User_ParameterSet(void){
    ...
    Sguan.pid.VelCur_D.Kp = 0.261f;          // 双PID电流内环D轴参数【PID参数自适应】
    Sguan.pid.VelCur_D.Ki = 958.4111f;         // 双PID电流内环D轴参数【PID参数自适应】
    ...
    Sguan.pid.VelCur_Q.Kp = 0.261f;          // 双PID电流内环Q轴参数【PID参数自适应】
    Sguan.pid.VelCur_Q.Ki = 958.4111f;         // 双PID电流内环Q轴参数【PID参数自适应】
    ...
    Sguan.pid.PosVelCur_D.Kp = 0.261f;        // 高性能伺服三环D轴【PID参数自适应】
    Sguan.pid.PosVelCur_D.Ki = 958.4111f;       // 高性能伺服三环D轴【PID参数自适应】
    ...
    Sguan.pid.PosVelCur_Q.Kp = 0.261f;        // 高性能伺服三环Q轴【PID参数自适应】
    Sguan.pid.PosVelCur_Q.Ki = 958.4111f;       // 高性能伺服三环Q轴【PID参数自适应】
    ...
    // 3.pll锁相环跟踪系统
    Sguan.foc.pll.Kp = 650.0f;                // 锁相环比例项增益【PID参数自适应】
    Sguan.foc.pll.Ki = 210000.0f;                // 锁相环积分项增益【PID参数自适应】
}
